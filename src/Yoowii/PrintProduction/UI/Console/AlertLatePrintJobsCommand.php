...
{
    public function __construct(private readonly EntityManagerInterface $entityManager, private readonly QueuePrintJobNotification $queue, private readonly SendPendingPrintJobNotifications $sender)
    {
        parent::__construct();
    }
