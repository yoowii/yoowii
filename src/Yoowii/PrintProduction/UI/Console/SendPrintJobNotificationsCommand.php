...
{
    public function __construct(private readonly SendPendingPrintJobNotifications $sender) { parent::__construct(); }

    protected function configure(): void { $this->addOption('limit', null, InputOption::VALUE_REQUIRED, 'Maximum number of notifications.', '100'); }

    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        $sent = ($this->sender)(max(1, (int) $input->getOption('limit')));
