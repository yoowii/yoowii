...
final class Version20260830220000 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE yoowii_print_job_notification (id INT AUTO_INCREMENT NOT NULL, print_job_id INT NOT NULL, fingerprint VARCHAR(128) NOT NULL, type VARCHAR(64) NOT NULL, recipient VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', sent_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', UNIQUE INDEX uniq_print_notification_fingerprint (fingerprint), INDEX IDX_9C3D9B1D727301B (print_job_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB");
